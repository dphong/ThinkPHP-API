<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\web\api\public/../application/api\view\map\position.html";i:1489123683;s:59:"D:\web\api\public/../application/api\view\index\header.html";i:1489485837;s:59:"D:\web\api\public/../application/api\view\index\footer.html";i:1488630856;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="head">
    <div class="headin">
        <a href="/index/user/home" class="logo"><h1 class="logoTxt">IOT</h1></a>
        <ul class="nav">
            <li class="navi"><a href="/index/user/home" id="service">开发者</a></li>
            <li class="navi"><a href="/api/index/sample" id="cases">API</a></li>
            <li class="navi"><a href="/api/map/index" id="device">设备</a></li>
        </ul>
<?php 
use think\Request;
