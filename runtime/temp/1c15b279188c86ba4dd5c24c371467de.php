<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"D:\web\api\public/../application/api\view\map\show2.html";i:1489118931;s:59:"D:\web\api\public/../application/api\view\index\header.html";i:1489754339;s:59:"D:\web\api\public/../application/api\view\index\footer.html";i:1488630856;}*/ ?>
<!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
#centre{height:590px;width:1001px}
#bp10{height:5px}
body{
    color: #333;
...
<center>
    <table class="table1">
        ...
        <tr id="lat">
            <td>
                <span id="nickname"><?php echo $v->lng; ?></span>
                <p id="nicknametrerror" style="display: none"><span class="errorLabel" id="lng"></span></p>
            </td>
            <td>
                <span id="telephone"><?php echo $v->lat; ?></span>
                <p id="telephonetrerror" style="display: none"><span class="errorLabel" id="lat"></span></p>
            </td>
            <td>
                <span id="telephone"><?php echo $v->add_time; ?></span>
                <p id="telephonetrerror" style="display: none"><span class="errorLabel" id="lat"></span></p>
            </td>
        </tr>
        <?php endforeach; ?>
